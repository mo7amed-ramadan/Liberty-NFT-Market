  ...
  return (
    <div className="flex flex-row flex-wrap items-center justify-between">
      <img
        ...
        alt={props.title}
        loading="lazy"
        className="w-[47%] rounded-2xl"
      />
      <div className="w-[47%] text-white">
        ...
        <div className="flex flex-row flex-wrap items-center justify-between">
          ...
          <div className="end flex flex-col items-center">
          ...
          <div className="flex flex-row items-center mt-8">
            ...
            <span className="mx-4 py-2 px-4 rounded-full border border-mainColor text-lg ">
              {props.eth}
            </span>
